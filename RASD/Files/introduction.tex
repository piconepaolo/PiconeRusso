...
\begin{itemize}
    ...
    \item \textbf{Version 1.1}  - 07/01/2024: Second release
        \begin{itemize}
            \item Added ``user logged in'' as entry condition for the following use cases:
            ...
            \textit{Close a Tournament}, \textit{Subscribe to a battle},
            \textit{Creation of a Team for a Battle}, \textit{Fork repository of a Battle},
