...
% Define an interface for LoginManager
...
% Define an interface for TournamentManager
...
% Define an interface for InvitationManager
...
% Define an interface for RankingManager
\textbf{Interface} RankingManager:
\begin{itemize}
    \item \texttt{void updateRank(User user, int newRank);}
    \item \texttt{int viewRank(User user);}
\end{itemize}

% Define an interface for SubmissionManager
